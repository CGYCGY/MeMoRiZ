...
class StudentClassList : MainActivityBaseFragment(), ClassListAdapterInterface {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        if (bundle != null) {
            ...
            setTitle("Joined Class List")
        }

        loadClassList()

        view.joinClassBtn.setOnClickListener {
            switchFragment(JoinClass())
        }
    ...
    private fun loadClassList() {
        val stringRequest = object : StringRequest(Request.Method.POST, URLEndpoint.urlJoinedClassList,
