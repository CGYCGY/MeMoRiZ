...
class StudentSlideSetList : MainActivityBaseFragment(),QuizSetAdapterInterface {
    ...
    fun newInstance(text : String) : StudentSlideSetList {
        val args = Bundle()
        args.putString("value1", text)
        val fragment = StudentSlideSetList()
        fragment.arguments = args
        return fragment
    }

    fun newInstance(classInfo : ClassData): StudentSlideSetList{
        val args = Bundle()
    ...
    override fun onClick(quiz: SetData) {
        ...
        switchFragment(StudentSlideSetDetail().newInstance(quiz))
    }
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        view.createSlideSetBtn.visibility = GONE
